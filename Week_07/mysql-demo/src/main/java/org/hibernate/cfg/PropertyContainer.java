...
/**
 * 重写hibernate的PropertyContainer,使创建的表的顺序与实体类顺序一致
 */
class PropertyContainer {
    ...
    private AccessType determineLocalClassDefinedAccessStrategy() {
        ...
        org.hibernate.annotations.AccessType accessType =
                xClass.getAnnotation(org.hibernate.annotations.AccessType.class);
        if (accessType != null) {
